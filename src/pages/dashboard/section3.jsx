...
const Section3 = () => {
  return (
    <div className='min-[980px]:flex mt-[50px] px-[5vw] gap-5'>
        <div className='mt-[80px] md:mt-[60px] text-[16px] md:text-[18px] xl:text-[24px] text-center text-white min-[980px]:text-left'>
        ...
        <div className='w-full mt-10 min-[980px]:mt-0 min-[980px]:w-[640px] flex gap-2 justify-center min-[980px]:justify-end'>
            <div>
