...
const Section2 = () => {
  return (
    <div className='min-[980px]:flex justify-between px-[5vw] gap-5'>
      ...
      <div className='mx-[10px] md:mx-0 text-white'>
        <div className='mt-[20px] md:mt-[60px] text-[16px] md:text-[18px] xl:text-[24px] text-center min-[980px]:text-left'>
