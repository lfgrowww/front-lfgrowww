...
const Section2 = () => {
  return (
    <div className='min-[980px]:flex justify-between px-[3vw] sm:px-[5vw] gap-5'>
      <div className='w-[60%] md:w-[400px] xl:w-[500px] mx-auto min-[980px]:mx-0'>
        <img src= {Layer2Img} alt="Diagram"/>
      </div>
      <div className='mx-[10px] md:mx-0 text-white'>
        <div className='mt-[20px] md:mt-[60px] text-[14px] md:text-[18px] xl:text-[24px] text-center min-[980px]:text-left'>
